...
// Source: github.com/hrvadl/book-service/internal/domain/review (interfaces: ReviewSource)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/mock_review.go -package=mocks . ReviewSource
//
